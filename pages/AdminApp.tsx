...
const AdminApp = () => {
    ...
    const renderContent = () => {
        switch (currentPage) {
            case 'dashboard': return <DashboardView onNavigate={handleNavigate} employees={filteredEmployees} attendance={filteredAttendance} />;
            ...
            />;
            case 'schedule': return <ScheduleView schedules={filteredSchedules} employees={filteredEmployees} onSchedulesChange={handleSchedulesChange} />;
            ...
            default: return <DashboardView onNavigate={handleNavigate} employees={filteredEmployees} attendance={filteredAttendance} />;
        }
    };
    ...
    return (
        <div className="min-h-screen bg-slate-100">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="relative" ref={storeSwitcherRef}>
                            <button
                                ...
                                disabled={accessibleStores.length <= 1}
                                className="text-left w-full rounded-md p-1 -m-1 hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:cursor-default disabled:opacity-75"
                                aria-haspopup="true"
                            ...
                            {isStoreSwitcherOpen && accessibleStores.length > 1 && (
                                <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg z-20 border" role="menu">
                                    ...
                                    <ul>
                                        {accessibleStores.filter(store => store !== currentStore).map(store => (
            ...
            <Modal 
                ...
                size="lg"
                titleAlign={employeeModalMode === 'new' ? 'center' : 'left'}
                hideCloseButton={employeeModalMode === 'new'}
            >
